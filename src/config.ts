...
export const siteConfig: SiteConfig = {
	title: "Tadawi Life Tech",
	subtitle: "tadawilifetech",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/tadawilifetech/tadawilifetech.github.io", // Internal links should not include the base path, as it is automatically added
